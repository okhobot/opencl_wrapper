...
* Uses OpenCL (tested with CUDA Toolkit 12.2)
...
* The file name must match the function name. For example, test\_kernel.cl contains the \_\_kernel void test\_kernel function
...
* Devices and their indexes can be obtained using the get\_available\_devices\_names() method
* The set\_logs\_output method is used to set the log stream
* The init\_kernel function is used to initialize new kernels
